...
<style>
    ...
    .subtitle-text { color: #a0a0a0; font-size: 1.1rem; }
...
if not df_raw.empty:
    ...
    col_sub, col_social = st.columns([3, 1])
    ...
    with col_social:
        st.markdown(
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end; align-items: center; margin-top: -5px;">
                ...
                <a href="https://github.com/ithiagojs" target="_blank">
    ...
    with tab_overview:
        ...
        with col_left:
            ...
            fig_hist = px.histogram(
                ...
                labels={"duration_minutes": "Duração (min)", "count": "Quantidade"}
            )
        ...
        with col_right:
            ...
            fig_scatter = px.scatter(
                ...
                labels={"trip_distance": "Distância (KM)", "fare_amount": "Tarifa ($)"}
            )
    ...
    with tab_business:
        ...
        with c1:
            ...
            st.plotly_chart(px.bar(df_hora, x="hora", y="Corridas", color_discrete_sequence=["#ffcc33"], labels={"hora": "Hora"}), use_container_width=True)
        with c2:
            ...
            st.plotly_chart(px.bar(df_dia, x="dia_semana", y="Corridas", color_discrete_sequence=["#ffd700"], labels={"dia_semana": "Dia"}), use_container_width=True)
