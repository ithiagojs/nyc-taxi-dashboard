...
# Configurações do Projeto (Centralizadas)
...
def process_taxi_data():
    ...
    # SQL unificado: Duração e Velocidade calculados em um único fluxo
    ...
    con.sql(f"CREATE TABLE taxi_data AS {transformation_query}")
